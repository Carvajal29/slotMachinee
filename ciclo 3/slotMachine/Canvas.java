...
public class Canvas{
    ...
    private static final HashMap<String, Color> cssColors = loadCssColors();
    ...
    /**
     * Construye el mapa de nombres CSS a colores de Java.
     * @return mapa con los colores
     */
    private static HashMap<String, Color> loadCssColors() {
    ...
    public static boolean isValidColor(String color) {
        return color != null && cssColors.containsKey(color);
    }
    ...
    public void setForegroundColor(String colorString) {
        Color color = cssColors.get(colorString);
        if (color == null) {
            color = Color.black;
        }
