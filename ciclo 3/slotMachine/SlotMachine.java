...
import java.util.Random;// ciclo 3
/**
...
public class SlotMachine
{
    ...
    public static final int BODY_WIDTH = 740;// ancho de la caja de la maquina 
    public static final int BODY_HEIGHT = 180;// alto de la caja de la maquina
    private static final String[] PALETTE = { // Ciclo 3 
    "red", "blue", "green", "gold", "purple",
    "orange", "cyan", "magenta", "brown", "pink",
    "teal", "navy", "olive", "coral", "crimson",
    "tomato", "salmon", "khaki", "violet", "indigo",
    "turquoise", "steelblue", "skyblue", "royalblue", "seagreen",
    "olivedrab", "chocolate", "tan", "beige", "lavender",
    "plum", "orchid", "slategray", "maroon", "silver",
    "gray", "black", "lime", "yellow", "darkgreen",
    "darkred", "darkblue", "goldenrod", "hotpink", "limegreen",
    "midnightblue", "peru", "sienna", "slateblue", "springgreen"};
    ...
    /**
     * Crea una maquina con n ruedas y n simbolos inicializada
     * aleatoriamente y garantiza que la configuracion inicial
     * no sea un jakpot.
     * @param n numero de ruedas y de simbolosque esta entre 3 y 50
     */
    public SlotMachine(int n) {
        this();
        if (n < 3 || n > PALETTE.length) {
            showError("El numero de ruedas debe estar entre 3 y " + PALETTE.length);
            ok = false;
            return;
        }
        for (int i = 1; i <= n; i++) {
    ...
    /**
     * Detiene un poco la ejecucion para que el giro se vea paso a paso.
     */
    private void pause() {
        try {
            Thread.sleep(150);
